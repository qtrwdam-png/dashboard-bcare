        ...
        <div className="relative rounded-3xl overflow-hidden"
          ...
          <div className="p-8 sm:p-10">
            ...
            <div className="flex flex-col items-center mb-10">
              ...
              <h1 className="text-2xl font-bold text-white mb-1.5 tracking-tight">تسجيل الدخول</h1>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={loading}
                    placeholder="••••••••"
                    className="w-full pr-10 pl-12 py-3.5 text-sm rounded-xl outline-none transition-all duration-200 disabled:opacity-50"
                    style={{
                      background: "rgba(255,255,255,0.04)",
                      border: "1px solid rgba(255,255,255,0.08)",
                      color: "#e2e8f0",
                  ...
                  <button
                    ...
                    className="absolute left-3.5 top-1/2 -translate-y-1/2 p-1 transition-colors"
                    style={{ color: "rgba(99,102,241,0.7)" }}
                  >
